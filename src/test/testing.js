    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        function updateDocument(filter, updateData) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, collection_1.updateOne(filter, { $set: updateData })];
                        case 1:
                            updateResult = _a.sent();
                            console.log("Updated :  ".concat(updateResult.modifiedCount));
                            return [2 /*return*/];
                    }
                });
            });
        ...
        function deleteDocument(filter) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, collection_1.deleteOne(filter)];
                        case 1:
                            deleteResult = _a.sent();
                            console.log("Deleted : ".concat(deleteResult.deletedCount));
                            return [2 /*return*/];
                    }
                });
            });
        }
        var database, collection_1, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
